...
const Footer = () => {
  ...
  return (
    <footer className="w-full bg-[#d8b192]">
      <div className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 md:px-8 lg:px-14 py-14 sm:py-16 md:py-20 lg:py-24">
        <div className="flex flex-col gap-8 md:gap-12 lg:gap-16 w-full">
          ...
          {/* Main columns */}
          <div className="flex flex-col lg:flex-row justify-between items-start gap-8 md:gap-12 lg:gap-16 w-full">

            <Reveal dir="up" delay={0}>
              <Link
                href="/"
                className="font-['Playfair_Display',Georgia,serif] text-[34px] sm:text-[40px] lg:text-[46px] italic tracking-[0.12em] text-white leading-none select-none"
              >
                Lily Studio
              </Link>
            </Reveal>

            <Reveal dir="up" delay={80} className="flex flex-col gap-4 sm:gap-5 w-full sm:w-auto">
            ...
            <Reveal dir="up" delay={160} className="flex flex-col gap-4 sm:gap-5 w-full sm:w-auto lg:w-[238px]">
              <h3 className="text-base sm:text-lg font-semibold leading-[25px] capitalize text-white font-[Heebo]">
                יצירת קשר
              </h3>
              <address className="text-sm sm:text-base font-normal leading-[25px] text-[#f3f3f3] font-[Heebo] not-italic">
            ...
            <Reveal dir="up" delay={240} className="flex flex-col gap-6 sm:gap-7 w-full sm:w-auto">
              <h3 className="text-base sm:text-lg font-semibold leading-[25px] text-white font-[Heebo]">
                רשתות חברתיות
              </h3>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-6 w-full">
            <p className="text-sm sm:text-base font-normal leading-5 text-[#f3f3f3] font-[Heebo] text-center sm:text-left">
              כל הזכויות שמורות
            </p>
