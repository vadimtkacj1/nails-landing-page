...
const treatments = [
  {
    name: 'מניקור ג׳ל ומבנה אנטומי',
    description: 'עיצוב מדויק של הציפורן, חיזוק המבנה הטבעי ומריחת ג׳ל עמידה ומוקפדת.',
    price: '₪150.00',
  },
  {
    name: 'פדיקור ספא מקיף',
    description:
      'טיפול מפנק לכפות הרגליים הכולל הסרת עור יבש, פילינג, עיסוי ועיצוב הציפורניים.',
    price: '₪180.00',
  },
  {
    name: 'בניית ציפורניים (פוליג׳ל/אקריל)',
    description: 'הארכת ציפורניים בטכניקות מתקדמות למראה טבעי, חזק ואסתטי לאורך זמן.',
    price: '₪280.00',
  },
  {
    name: 'מניקור קלאסי (ללא ג׳ל)',
    description:
      'ניקוי יסודי של הקוטיקולה, שיוף, עיצוב הציפורן ומריחת לק מחזק או צבע רגיל.',
    price: '₪80.00',
  },
];
