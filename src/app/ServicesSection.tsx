...
const services: Service[] = [
  {
    ...
    title: 'מניקור קלאסי & טיפוח',
    description:
      'פינוק אמיתי לידיים שלך. אנחנו דואגים לכל פרט - מהסרת קוטיקולה נקייה, שיוף מדויק ועד למראה מלוטש ובריא שיחזיק לאורך זמן.',
    iconW: 124,
    iconH: 112,
  },
  {
    ...
    title: 'אמנות בעיצוב אישי',
    description:
      'הפכי את הציפורניים שלך ליצירת אמנות. ציורים עדינים, פרנץ\' מודרני או שילוב אלמנטים ייחודיים – הכל בהתאמה מלאה לסגנון האישי שלך.',
    iconW: 142,
    iconH: 162,
  },
  {
    ...
    title: 'קולקציית צבעים & השראה',
    description:
      'בואי להתעדכן בגוונים הכי חמים של העונה ובטרנדים העדכניים ביותר מעולם המניקור. ייעוץ מקצועי להתאמת הצבע המושלם עבורך.',
    iconW: 122,
    iconH: 112,
  },
]
